...
# Find all <li> elements with class="item product product-item" and data-sku="5501377-P"
product_items = soup.find_all("li", class_="item product product-item", attrs={"data-sku": "5501377-P"})
...
for item in product_items:
    ...
    # Extract description
    description_tag = item.find("div", class_="value")
